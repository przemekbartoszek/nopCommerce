...
namespace Nop.Plugin.Api.Infrastructure
{
    public class ApiPlugin : BasePlugin, IAdminMenuPlugin
    {
        ...
        public override async Task InstallAsync()
        {
            ...
            await _localizationService.AddOrUpdateLocaleResourceAsync("Plugins.Api.Admin.EnableApi.Hint", "By checking this settings you can Enable/Disable the Web Api");
        ...
        {
            var workingLanguage = AsyncHelper.RunSync(() => _workContext.GetWorkingLanguageAsync());
            var pluginMenuName = AsyncHelper.RunSync(() => _localizationService.GetResourceAsync("Plugins.Api.Admin.Menu.Title", workingLanguage.Id, defaultValue: "API"));

            var settingsMenuName = AsyncHelper.RunSync(() => _localizationService.GetResourceAsync("Plugins.Api.Admin.Menu.Settings.Title", workingLanguage.Id, defaultValue: "API"));
