...
namespace Nop.Plugin.Api.Helpers
{
    public class DTOHelper : IDTOHelper
    {
        ...
        private List<int> GetRelatedProductIdsByProductId(int productId)
        {
             ...
             ProductAttributeMapping productAttributeMapping)
        {
            ...
            if (productAttributeMapping != null)
            {
                productAttributeMappingDto = new ProductAttributeMappingDto
                {
                    ...
                    //TODO: Somnath
                    ProductAttributeValues = _productAttributeService
                                    .GetProductAttributeValues(productAttributeMapping.Id)
                                    .Select(x => x.ToDto())
                                    .ToList()
                };
            }
