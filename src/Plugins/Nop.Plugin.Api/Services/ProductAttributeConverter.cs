...
namespace Nop.Plugin.Api.Services
{
    public class ProductAttributeConverter : IProductAttributeConverter
    {
        ...
        public string ConvertToXml(List<ProductItemAttributeDto> attributeDtos, int productId)
        {
            ...
            var productAttributes = AsyncHelper.RunSync(() => _productAttributeService.GetProductAttributeMappingsByProductIdAsync(productId));
                    ...
                    case AttributeControlType.ReadonlyCheckboxes:
                        {
                            ...
                            var attributeValues = AsyncHelper.RunSync(() => _productAttributeService.GetProductAttributeValuesAsync(attribute.Id));
                    ...
                    case AttributeControlType.FileUpload:
                        {
                            ...
                            if (selectedAttribute != null)
                            {
                                ...
                                var download = AsyncHelper.RunSync(() => _downloadService.GetDownloadByGuidAsync(downloadGuid));
                                if (download != null)
                                {
                                    attributesXml = _productAttributeParser.AddProductAttribute(attributesXml,
